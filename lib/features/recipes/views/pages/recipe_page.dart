...
import 'package:overdose/core/widgets/fade_in_effect.dart';
import 'package:overdose/features/ingredients/views/widgets/ingredients_section.dart';
import 'package:overdose/features/recipes/models/recipe.dart';
import 'package:overdose/features/recipes/views/widgets/recipe_page_sidebar.dart';
import 'package:overdose/features/recipes/views/widgets/recipe_page_sliver_app_bar.dart';
  ...
  void scrollListener() {
    ...
    if (scrollDirection == ScrollDirection.forward) {
      imageRotationAngleNotifier.value +=
          (scrollPosition * math.pi / 360) * 0.01;
